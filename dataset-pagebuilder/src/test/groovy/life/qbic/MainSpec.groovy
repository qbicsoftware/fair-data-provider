...
class MainSpec extends Specification {
    var exampleFilePath = (Path.of(this.getClass().getResource("/Test_example.tsv").toURI()))

    def "read from test resource"() {

        given:
        List<String> testTSV = Files.readAllLines(exampleFilePath)
        when:
        var numberOfLines = testTSV.size()
